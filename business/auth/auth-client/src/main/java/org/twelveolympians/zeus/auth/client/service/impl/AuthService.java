package org.twelveolympians.zeus.auth.client.service.impl;

import org.twelveolympians.zeus.auth.client.provider.AuthProvider;
...
public class AuthService implements IAuthService {
    ...
    public Result authenticate(String authentication, String url, String method) {
        return Result.success(true); //authProvider.auth(authentication, url, method);
    }
